/**
 * @providesModule RNRFToolBox.PopUp
 */
...
export default class PopUp extends React.PureComponent {
  static propTypes = {
    ...
    statusBarBehaviour: React.PropTypes.oneOf(['fade', 'slide']),
  ...
  componentDidMount() {
    const { duration, statusBarBehaviour } = this.props;

    if (!_.isEmpty(statusBarBehaviour)) StatusBar.setHidden(true, statusBarBehaviour);
  ...
  dismiss = () => {
    ...
    if (!_.isEmpty(statusBarBehaviour)) StatusBar.setHidden(false, statusBarBehaviour);
